    ...
    <div className='w-full min-h-screen flex justify-center items-center'>
      <div className='border border-gray-300 p-4 rounded-md w-90 md:w-100'>
        ...
        <form onSubmit={handleSubmit} className='space-y-2 flex flex-col text-lg'>
          ...
          {click ? <FaEyeSlash onClick={handleSetClick} className='relative flex left-75 sm:left-85 -top-10 active:border-1 active:border-white active:rounded-full' /> : <FaEye onClick={handleSetClick} className='relative flex left-75 sm:left-85 -top-10 active:border-1 active:border-white active:rounded-full' />}
